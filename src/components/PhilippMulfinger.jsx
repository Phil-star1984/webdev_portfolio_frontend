        ...
        <div className="w-lg-50 d-flex justify-content-center align-items-center">
          <div className="text-secondary mt-sm-4 mb-sm-4">
            ...
            <h3 className="font-weight-light">
              Seit meinen Anfängen als Senior Art Director Online🎨 und jetzt als
              Webentwickler war mein Karriereweg voller vielfältiger Erfahrungen
              und Möglichkeiten. Jetzt bringe ich meine Designkompetenz🖌️ in den
              digitalen Bereich ein💻 und bin auf Technologien wie React,
              Express.js und die MERN- und PERN-Stacks spezialisiert. 🚀 Meine
              Reise ist eine kontinuierliche Weiterentwicklung und ich freue
              mich darauf, neue Horizonte zu erkunden und an spannenden
              Projekten mitzuarbeiten. Lassen Sie uns miteinander in Kontakt
              treten und darüber diskutieren, wie wir gemeinsam fantastische
